...
- [ ] WS-01 Auth & Session Lifecycle (`ws/01-auth-session-lifecycle`)
- [ ] WS-02 DAG-CBOR & Data Model Completion (`ws/02-dag-cbor-data-model`)
- [ ] WS-03 Cryptography Parity (`ws/03-crypto`)
- [ ] WS-04 MST, Repository & CAR Files (`ws/04-mst-repo-car`)
- [ ] WS-05 Firehose, Tap & Streaming Sync (`ws/05-sync-streaming`)
- [ ] WS-06 Identity Completion & PLC Operations (`ws/06-identity-plc`)
- [ ] WS-07 XRPC Client Ergonomics & API Conveniences (`ws/07-xrpc-client-ergonomics`)
- [ ] WS-08 Service Auth & XRPC Server Completion (`ws/08-service-auth-xrpc-server`)
- [ ] WS-09 Lexicon Resolution & Validation Modes (`ws/09-lexicon-completion`)
